...
class RecipeView extends View {
  ...
  _errorMessage = 'Could not find recipe with this id...';
  _message = '';
  ...
  _generateMarkup() {
    ...
    <div class="recipe__details">
      ...
      <div>
          <label for="calendar">Add date:</label>
          <input type="date" id="calendar" name="calendar">
          <button class="btn btn--calendar">
            <span>${
              this._data.calendered ? 'Remove from' : 'Add to'
            } calendar</span>
          </button>
    ...
    <div class="recipe__ingredients">
      <h2 class="heading--2">Recipe ingredients${this._generateMarkupCalories()}</h2>
